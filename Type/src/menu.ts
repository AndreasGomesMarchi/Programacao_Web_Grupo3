...
import { cadastrarTag, listarTags } from "./services/tagService.js";
  ...
  while (true) {
    ...
    switch (op) {
      ...
      case "8":
        ...
        await cadastrarTag(nomeTag); // Certifique-se de importar do tagService.js
        break;
